...
public class AlmacenService {
    ...
    public AlmacenService(IRegistroEnvioRepository envioRepository, ILoteDespachoRepository loteRepository) {
    ...
    public String clasificarEnvio(String numeroTracking) {
        ...
        String destino = envio.getDatosPaquete() != null ? envio.getDatosPaquete().getDireccionDestino() : null;
